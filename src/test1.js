...
export default function Test1() {
   ...
   // todo find solution to remove multi object from mapareas without copy areas every time
    ...
    const handleShow = () => setShow(true);
      ...
      // floor 1 handle
    const handleClickFloor1= ()=> {
    const color ="#ecdb9a"
        setMapAreas({
            name: "Floor 1",
            areas:[
                { id: 6, shape: "poly", coords: [249,85,246,173,383,172,381,162,401,162,439,79], preFillColor: color ,fillColor: "#7fb775"  },
                { id: 7, shape: "poly", coords: [361,227,357,248,333,246,328,289,338,293,335,335,428,351,446,239], preFillColor: "#e5787c",fillColor: "#7fb775"  },
            ]
        });
    }
...
// handle onclick floor 3
    ...
    return (
        ...
        <div className="container">
            ...
            <div className="container">
            <button onClick={handleClickFloor1}>Floor 1</button>
